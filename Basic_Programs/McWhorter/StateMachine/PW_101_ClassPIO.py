...
# myServo1=servoState(3)
# myServo2=servoState(2)
...
#         myServo1.servoAngle(angle)
#         myServo2.servoAngle(180-angle)
#################2 April 25 making a servo class
import time
from machine import Pin
import rp2
...
class servoState():
    ...
    def servoSet():
        ...
        wrap()
    def __init__(self,servoPin):
        self.sm = rp2.StateMachine(servoState.counter,servoState.servoSet, servoState.freq, set_base=servoPin)
        self.sm.active(1)
        self.sm.put(20000)
        self.sm.exec("pull()")
        self.sm.exec('mov(isr,osr)')
...
#         pw=int(500+angle*2000/180)
#         myServo1.put(pw)
#         # myxServo1.servoSet.put(2500-pw)
