...
'''
## simple oled display works, 20 March2025
...
######### but on retry 20 March 25  works great!!
##this works but when buzzer triggers ,will sometimes get hung up and buzzer stays on and distance stays locked under 20cm, oled not displaying either
import rp2
