'''
source of this library https://github.com/PerfecXX/MicroPython-SSD1306/tree/main
At bottom is the other ssd1306py library and a test.py for it
...
## below is the conventional ssd1306.py library does not use softI2C
## sample test.py at bottom that works with this library
